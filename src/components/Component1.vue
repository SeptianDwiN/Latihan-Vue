...
<hr>
<br>
<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><center><u>Sepatu</u></center></h5>
<br>
<div class=" grid grid-cols-2 pl-12">
  <the-card href="#"  variant="horizontal" img-src="https://down-id.img.susercontent.com/file/sg-11134201-23010-3sqzdvnlb7lv9b" img-alt="Desk">
    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">GIFLY Nesya Sepatu Sneakers Wanita Korea Import TH1618-11</h5>
    <p class="font-normal text-gray-700 dark:text-gray-400">
...
<hr>
<br>
<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><center><u>Celana</u></center></h5>
<br>
<div class=" grid grid-cols-2 pl-12">
  <the-card href="#"  variant="horizontal" img-src="https://cdn.arenaexperience.com/images/imagepro/imgpro_1685263909963050606.jpg" img-alt="Desk">
    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">WHIR BLACK CARGO PANTS</h5>
    <p class="font-normal text-gray-700 dark:text-gray-400">
    <p>- 100% cotton textile weaves (twill) materials. </p>
    <p>- Sturdy twill fabric wears in over time without compromising it's durability.</p>
    <p>- Regular fit long cargo pants with vertical expose zipper.</p>
    <p>- 5 pockets available (2 on front, 2 on back and 1 coin pocket).</p>
  ...
  <the-card href="#"  variant="horizontal" img-src="https://cdn.arenaexperience.com/images/imagepro/imgpro_1685263645567264405.jpg" img-alt="Desk">
    ...
    <p class="font-normal text-gray-700 dark:text-gray-400">
    <p>- Denim 14oz with 95% cotton and 5% elastone material. </p>
    <p>- Features embroidery Easthood graphic.</p>
    <p>- Baggy fit pants with a slight taper.</p>
    <p>- Garment bio wash treatment.</p>
    <p>- Available 5 pockets (2 side pocket, 2 back pocket and 1 coin pocket).</p>
    <p>- Machine wash cold with gentle cycle.</p>
    <p>- This pants is the right thing to wear for any occasions.</p>
    </p>
    <br>
